            ...
            {   
                ...
                if(sscanf(buffer,"%s : .%s",nom,type)==2){
                    ...
                    if(strcmp(type,"word")==0){
                        data_counter+=4;
                        char* amount=(char*)malloc(20*sizeof(char));
                        if (sscanf(buffer, "%*[^,]%s",amount)== 1) {
                                int i=0;
                                while(amount[i]!='\n'){
                                    if(amount[i]==',') data_counter+=4;
                                    i++; 
                                }
                        }
                        free(amount);
                        ...
                        if(len<4) data_counter+=4;
                        else{ 
                            if(len%4==0) data_counter+=len;
                            else data_counter+=(len+(4-len%4));
                        }
                        free(value);
                    }
